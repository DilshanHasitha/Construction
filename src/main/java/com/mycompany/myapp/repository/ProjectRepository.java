...
public interface ProjectRepository extends JpaRepository<Project, Long>, JpaSpecificationExecutor<Project> {
    ...
    @Query(
        value = "select distinct project from Project project left join fetch project.location left join fetch project.exUser",
    ...
    @Query("select distinct project from Project project left join fetch project.location left join fetch project.exUser")
    List<Project> findAllWithToOneRelationships();

    @Query("select project from Project project left join fetch project.location left join fetch project.exUser where project.id =:id")
