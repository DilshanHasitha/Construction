...
import { EntityArrayResponseType, CertificateTypeService } from '../service/certificate-type.service';
...
export class CertificateTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICertificateType): number => this.certificateTypeService.getCertificateTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.certificateTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICertificateType[] | null): ICertificateType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.certificateTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
