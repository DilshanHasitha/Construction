...
describe('CertificateType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'certificate-type', component: CertificateTypeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.certificateTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to certificateTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCertificateTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCertificateTypeIdentifier).toHaveBeenCalledWith(entity);
