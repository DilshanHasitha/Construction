...
describe('OrderStatus Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'order-status', component: OrderStatusComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to orderStatusService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrderStatusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrderStatusIdentifier).toHaveBeenCalledWith(entity);
