...
import { EntityArrayResponseType, UnitOfMeasureService } from '../service/unit-of-measure.service';
...
export class UnitOfMeasureComponent implements OnInit {
  ...
  trackId = (_index: number, item: IUnitOfMeasure): number => this.unitOfMeasureService.getUnitOfMeasureIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.unitOfMeasures = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IUnitOfMeasure[] | null): IUnitOfMeasure[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.unitOfMeasureService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
