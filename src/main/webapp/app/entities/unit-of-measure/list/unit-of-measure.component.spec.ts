...
describe('UnitOfMeasure Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'unit-of-measure', component: UnitOfMeasureComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.unitOfMeasures?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to unitOfMeasureService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUnitOfMeasureIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUnitOfMeasureIdentifier).toHaveBeenCalledWith(entity);
